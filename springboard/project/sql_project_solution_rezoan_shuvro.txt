...
SELECT name AS facility_name, CONCAT( firstname, ' ', surname ) AS name, slots, Bookings.memid,
...
SELECT CONCAT( firstname, ' ', surname ) AS name, name AS facility_name,
CASE
...
AND  (((Bookings.memid =0) AND (slots*guestcost >30)) OR ((Bookings.memid !=0) AND (slots*membercost >30)))
ORDER BY cost DESC 

/* Q9: This time, produce the same result as in Q8, but using a subquery. */

SELECT name, facility_name, cost
FROM
(
SELECT CONCAT( firstname, ' ', surname ) AS name, name AS facility_name,
CASE
...
SELECT facility_name, totalrevenue
FROM 
